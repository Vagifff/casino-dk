        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href={getLinkWithGclid("/")} className="text-[#F5F6F7] hover:text-[#18FFFF] transition-colors">
                  Home
                </Link>
              </li>
              <li>
                <Link href={getLinkWithGclid("/about")} className="text-[#F5F6F7] hover:text-[#18FFFF] transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href={getLinkWithGclid("/contact")} className="text-[#F5F6F7] hover:text-[#18FFFF] transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href={getLinkWithGclid("/terms")} className="text-[#F5F6F7] hover:text-[#18FFFF] transition-colors">
                  Terms & Conditions
                </Link>
              </li>
              <li>
                <Link href={getLinkWithGclid("/privacy")} className="text-[#F5F6F7] hover:text-[#18FFFF] transition-colors">
                  Privacy Policy
                </Link>
              </li>
            </ul>
